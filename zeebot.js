...
//»»»𝘔𝘦𝘥𝘪𝘢 𝘔𝘦𝘯u
    ...
    case 'sticker': case 'stiker': case 'sg': case 's':
          ...
          .on('error', (e) => {
          console.log(e)
          zee.sendMessage(from, 'Terjadi kesalahan', 'conversation', { quoted: troli })
          fs.unlinkSync(media)
          })
          .on('end', () => {
          _out = getRandom('.webp')
          ...
          .on('exit', () => {
          zee.sendMessage(from, fs.readFileSync(_out),'stickerMessage', { quoted: troli })
          fs.unlinkSync(out)
          fs.unlinkSync(_out)
          fs.unlinkSync(media)
          })
...
if (isBanned) return reply(mess.banned)
 ...
 footerText: '© Creator By deff Official',
...
//»»»𝘋𝘰𝘸𝘭𝘰𝘢𝘥𝘦𝘳 𝘔𝘦𝘯𝘶    								
    ...
    case 'ytmp3':                  
          ...
          await zee.sendMessage(from, mp3, audio, { mimetype: 'audio/mp4', filename: `${get_dl.result.title}.mp3`, quoted: troli}).catch(e => {
    ...
    case 'ytmp4':
          ...
          await zee.sendMessage(from, mp4, video, { mimetype: 'video/mp4', filename: `${get_hasil.result.title}.mp3`, quoted: troli,caption:hm}).catch(e => {
          reply('Gagal Dalam Mendownload Lagu')
          })
          break
    ...
    case 'tiktokdl': case 'ttdl': case 'tiktokmp4': case 'tiktok':    	        	
          ...
          .then(async (a) => {
    	  me = fake
	      zee.sendMessage(from,{url:`${nowm}`},video,{mimetype:'video/mp4',quoted:troli,caption:me})
	      limitAdd(sender, limit)
          })
		  })
		  break
    ...
    case 'mediafire':
          ...
          break
          case 'dwd':
          sendFileFromUrl(res[0].link, document, {mimetype: res[0].mime, filename: res[0].nama, quoted: troli}).catch(e => {
...
//+++Random
    case 'waifu': case 'loli': case 'husbu': case 'milf': case 'cosplay': case 'wallml':
          ...
          await zee.sendMessage(from, ButtonssMessages, MessageType.buttonsMessage, {quoted : troli})
...
//»»»𝘔𝘢𝘬𝘦𝘳 𝘔𝘦𝘯𝘶          
  // Textprome //
    ...
    case 'horrorblood':   case 'thunder':
          ...
          zee.sendMessage(from, gambar, image, {quoted:troli, caption: 'Nih kak'}).catch(e => {
...
│ *Untuk menggunakan bot ini*
│ *Cukup ketik #menu*
│ *Kalo gapaham tanya owner* 
│ *ingin berteman dengan saya ketik owner*
├────────────────
│ KASIH BOT WAKTU 5 DETIK
╰━━━━━━━━━━━━┈ ❋ཻུ۪۪⸙
`
...
{buttonId: `!sm`, buttonText: {displayText: 'STORE'}, type: 1},
...
vcard3 = 'BEGIN:VCARD\n' +
            ...
            `item2.EMAIL;type=INTERNET: hg3372748@gmail.com\n` +
            ...
            `item5.X-ABLabel:⚔️ Hendra - Botz Owner\n` +
            'END:VCARD'.trim()
